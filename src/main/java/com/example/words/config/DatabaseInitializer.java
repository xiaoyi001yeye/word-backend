...
public class DatabaseInitializer {
    ...
    @Value("${database.init.scripts:db/migration/V1__init_word_vocabulary.sql,db/migration/V2__create_dictionary_tables.sql,db/migration/V3__add_dictionary_creation_type.sql,db/migration/V4__add_jsonb_fields_to_meta_words.sql,db/migration/V5__migrate_data_to_jsonb.sql,db/migration/V7__ensure_dictionary_words_unique_constraint.sql,db/migration/V7__create_exam_tables.sql,db/migration/V8__add_selected_option_to_exam_questions.sql,db/migration/V9__add_user_role_support.sql,db/migration/V10__add_classroom_support.sql,db/migration/V11__add_famous_quotes.sql,db/migration/V13__add_famous_quote_translations.sql,db/migration/V14__add_study_plan_support.sql,db/migration/V15__deduplicate_study_plan_data_and_add_constraints.sql}")
